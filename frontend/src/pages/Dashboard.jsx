        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-300 text-sm max-w-xl leading-relaxed font-medium">
              Maintain daily consistency across coding,
              quizzes, and interview preparation.
            </p>
        ...
        {[
          {
            ...
            value: accuracyDisplay,
            sub: `${progress?.totalAttempted || 0} total attempts`,
            color: "from-indigo-500 to-indigo-600",
            path: "/progress",
          },

          {
            label: "Current System Streak",
            value: `${progress?.currentStreak || 0} 🔥`,
            sub: `Personal best: ${progress?.longestStreak || 0} days`,
...

          {
            ...
            value: progress?.codeSolved || 0,
            sub: "Verified structural responses",
            color: "from-emerald-500 to-teal-500",
            path: "/coding",
          },

          {
            label: "Corporate Simulations",
            value: progress?.mockInterviewsDone || 0,
            sub: "Mock sessions finalized",
          ...
          >
            <div
              className={`absolute top-0 left-0 w-1.5 h-full bg-gradient-to-b ${card.color}`}
            />
        ...
        <div className="bg-white border border-slate-200/60 rounded-2xl p-6 shadow-sm h-full">
          ...
          {loading ? (
            ...
            <div className="py-10 text-center flex flex-col items-center justify-center border border-emerald-100 bg-emerald-50/20 rounded-xl">
              ...
              <h4 className="text-sm font-bold text-emerald-800 mt-2">
                Zero Platform Vulnerabilities
              </h4>

              <p className="text-xs text-slate-400 mt-0.5">
                All modules performing above baseline.
              </p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-4">
          ...
          {modules.map((mod, idx) => (
            ...
            >
              ...
              <div
                className={`absolute -right-6 -bottom-6 w-20 h-20 bg-gradient-to-br ${mod.gradient} opacity-[0.03] rounded-full`}
              />

              <div
                className={`w-9 h-9 rounded-lg bg-gradient-to-br ${mod.gradient} text-white flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform`}
              >
                {mod.icon}
              </div>
