...
import {
  ...
  Code2, Mic, BookOpen, BarChart3, Star, CheckCircle2, ShieldCheck,
} from "lucide-react";
          ...
          <div className="space-y-8 overflow-y-auto min-h-0">
            <div>
              ...
              <p className="text-slate-400 text-sm mt-3 leading-relaxed max-w-sm">
                Choose something strong — you'll be back to prepping in no time.
              </p>
            </div>
          ...
          <div className="flex-1 flex flex-col justify-center max-w-xs w-full mx-auto py-4">
            ...
            {msg ? (
              ...
              <div className="text-center">
                ...
                <h1 className="text-xl font-black text-white tracking-tight leading-tight">Password reset</h1>
                <p className="text-slate-500 text-xs mt-2 leading-relaxed">{msg}</p>
                <p className="text-slate-600 text-[11px] mt-3">Redirecting to login…</p>
              </div>
            ) : (
              // ── Request state ───────────────────────────────────────
              <>
                <div className="mb-5">
                  ...
                  <h1 className="text-2xl font-black text-white tracking-tight leading-tight">Reset password</h1>
                  <p className="text-slate-500 text-xs mt-1">Enter your new password below</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div>
                    <label className="block text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-1">New Password</label>
